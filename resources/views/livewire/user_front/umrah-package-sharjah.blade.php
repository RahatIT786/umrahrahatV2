                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <h3 class="display-3 text-white mb-4 animated slideInDown">Umrah Packages from Sharjah</h3>
        ...
        <div class="container-xxl py-5" id="about">
            <div class="container" >
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h4 class=" text-start text-primary text-uppercase">Umrah Packages from Sharjah</h4>
                        <p class="mb-4">Rahat Group is providing cheapest umrah packages from sharjah , dubai  including Umrah Package by Bus , Umrah Package by Air and umrah visa with 5 star accomodation . Being as a reliable partner for Umrah Visa from Dubai & Sharjah we have attained a distinct reputation among the public for providing the highest level of service to the pilgrims at very affordable prices.</p>
                        <p>The staff works with an element of dedication and professionalism to continuously improve the standard of service offered to the pilgrims. This reputation is attained by streamlining, harmonizing and educating the staff about the pilgrims needs and the management’s evolving concept of service excellence.</p>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase mb-5">Umrah Packages from Sharjah</h6>
                 ...
                 <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <P>Hotel Accommodation (2 Nights Madinah & 3 Nights Makkah)</P>
                                <P>Complete Transportation</P>
                                <p>Haramain High Speed Train from Madinah to Makkah Transfer</p>
