            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="asserts/user/img/aboutimg1.jpg" style="height: 200px; width:100%" alt="">
                            </div>
                            <div class="p-4 mt-2 ">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp  " data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="asserts/user/img/aboutimg2.jpg" style="height: 200px; width:100%" alt="">
                            </div>
                            <div class="p-4 mt-2">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.6s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="asserts/user/img/aboutimg3.jpeg" style="height: 200px; width:100%" alt="">
                            </div>
                            <div class="p-4 mt-2">
