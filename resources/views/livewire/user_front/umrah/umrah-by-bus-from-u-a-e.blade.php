                                ...
                                <div class="d-flex justify-content-between mb-0">
                                   <div>
                                    ...
                                    @foreach ($packageIncludesArray as $include)
                                        @if ($include == 2)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"> <i class="fa-solid fa-bottle-water"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                        @elseif ($include == 3)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"> <i class="fa-solid fa-bus"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                        @elseif ($include == 4)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"> <i class="fa-solid fa-sim-card"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                       
                                        @elseif ($include == 5)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"><i class="fa-solid fa-bag-shopping"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                        
                                        @elseif ($include == 6)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"><i class="fa-solid fa-bowl-food"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                        <span class=""></span>
                                        @elseif ($include == 7)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"><i class="fa-solid fa-person-praying"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span> 
                                        
                                        @elseif ($include == 8)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"> <i class="fa-brands fa-cc-visa"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span>
                                         
                                        @elseif ($include == 9)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2"> <i class="fa-solid fa-ticket"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span>
                                       
                                        @elseif ($include == 10)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2">  <i class="fa-solid fa-jug-detergent"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span>
                                      
                                        @elseif ($include == 11)
                                        <span style="font-size: 25px;color:#007bff;" class="mx-2">  <i class="fa-solid fa-file-shield"></i></span> <span style="font-size: 15px;color:#007bff;" class="mt-2"></span>
