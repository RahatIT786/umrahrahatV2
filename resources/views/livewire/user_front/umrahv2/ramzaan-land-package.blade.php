<section style="margin-bottom:150px">
    ...
    <div class="container-fluid page-header mb-5 p-0"
        style="background-image: url({{ asset('asserts/user/img/haj/mecca3.jpg') }});">
                        ...
                        <div class="row g-2">
                            <div class="col-md-8">
                                <form wire:submit.prevent="" class="date" id="date2">
                                    <input wire:model.live="searchPackage" type="text" class="form-control"
    ...
    <!-- Package Start -->
    <!-- Package Start -->
    <div style="padding-bottom: 70px;" class="container-fluid ">
        <div class="container-fluid" style=" max-width: 80% !important">
            <div class="row">
                <div class="col-md-3 d-none d-lg-block">
                    <div class="card p-3 filter-card">
                        {{-- <h6><strong>4 out of 4 packages</strong></h6> --}}
                        <div class="d-flex justify-content-between">
                            <span>Filter</span>
                            {{-- <a href="#" wire:click.prevent="resetFilters" class="text-decoration-none"><i class="bi bi-arrow-clockwise"></i> Reset</a> --}}
                        </div>

                        <form wire:submit.prevent="" class="date" id="date2">
                            <input wire:model.live="searchPackageForm" type="text" class="form-control"
                                placeholder="Search Package Name" />
                        </form>
                        ...
                        <div class="mt-3">
                            ...
                            @foreach ($packageDays as $i => $day)
                                <div class="form-check">
                                    <input wire:click="selectSingle('{{ $day }}')" class="form-check-input"
                                        type="checkbox" id="nights{{ $day }}" value="{{ $day }}"
                                        @if ($searchPackageDays == $day) checked @endif>
                                    <label class="form-check-label" for="nights{{ $day }}">{{ $day }}
                                        Nights</label>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            @foreach ($this->largestDepartCity as $i => $city)
                                <div class="form-check">
                                    <input wire:model.live="searchPackageCity.{{ $city }}"
                                        class="form-check-input" type="checkbox" id="city.{{ $city }}"
                                        value="{{ $city }}">
                                        ...
                                        <div style="height: 30rem;" class="col-lg-8 col-md-8 px-4 mt-0">
                                            <div class="d-flex justify-content-between mb-0">
                                                <div>
                                                    ...
                                                    <div class="d-flex my-2">
                                                        ...
                                                        @foreach ($packageIncludesArray as $include)
                                                            @if ($include == 2)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class="mx-2"> <i
                                                            ...
                                                            @elseif ($include == 3)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class=""> <i
                                                                            class="fa-solid fa-bus"></i></span>
                                                            ...
                                                            @elseif ($include == 4)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class=""> <i
                                                                            class="fa-solid fa-sim-card"></i></span>
                                                            ...
                                                            @elseif ($include == 7)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class="mx-2"><i
                                                                            class="fa-solid fa-person-praying"></i></span>
                                                            ...
                                                            @elseif ($include == 8)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class=""> <i
                                                                            class="fa-brands fa-cc-visa"></i></span>
                                                            ...
                                                            @elseif ($include == 10)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class=""> <i
                                                                            class="fa-solid fa-jug-detergent"></i></span>
                                                            ...
                                                            @elseif ($include == 11)
                                                                <div
                                                                    class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                    <span style="font-size: 20px;" class=""> <i
                                                                            class="fa-solid fa-file-shield"></i></span>
                                                            ...
                                                            @elseif ($include == 17)
                                                                <div
                                                                    ...
                                                                    <span style="font-size: 12px;">Hotel</span>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                        @if (in_array(15, $packageIncludesArray) || in_array(18, $packageIncludesArray))
                                                            <div
                                                                class="d-flex flex-column mx-2 justify-content-center align-items-center">
                                                                <span style="font-size: 20px;" class=""> <i
                                                                        class="fa-solid fa-person-chalkboard"></i></span>
                                                                <span style="font-size: 12px;">Professional
                                                                    Guide</span>
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <p class=""> <strong>Total Nights :</strong>
                                                            {{ $package->package_days }} Nights ,</p>
                                                        <p class="mx-3"> <strong> Makkah Nights:</strong>
                                                            {{ $package->makkah_nights }}, &nbsp; <strong> Madina
                                                                Nights:</strong> {{ $package->madina_nights }}</p>
                                                    </div>
                                                </div>
                                                @php
                                                    $minPrice = min(
                                                ...
                                                <div class="ps-2">
                                                    ...
                                                    <div class="text-end">
                                                        <del class="text-danger">{{ $minPrice * 1.1 }}.SAR</del>
                                                        <p class="text-end" style="color: black;"><span
                                                                style="font-size: 22px;   font-weight: 500;">{{ $minPrice }}</span>.SAR
                                                            <br>
                                                            <span
                                                                style="color: green; font-size: 11px; font-weight: 600;">YOU
                                                                SAVED {{ $minPrice * 1.1 - $minPrice }}.SAR <i
                                                                    class="fa-solid fa-sack-xmark"></i></span>
                                                        </p>
                                            ...
                                            <div>
                                                <p style="border: 1px dashed #FEA116; padding:2px 4px;"
                                                    class="">

                                                    <span class="mx-3"> <span
                                                            style="font-weight:500; color: #0D1425;"> <i
                                                                class="fa-solid fa-hotel"></i> Makkah Hotel :
                                                        </span><span>{{ ucfirst($package->packageDetail->makkaHotelDetail->hotelName) ?? 'Hotel Name Not Available' }}</span></span>
                                                    <span class="mx-3"> <span class="mx-3"
                                                            style="font-weight:500; color: #0D1425;"> <i
                                                                class="fa-solid fa-hotel"></i> Madina Hotel :
                                                        </span><span>{{ ucfirst($package->packageDetail->madinaHotelDetail->hotelName) ?? 'Hotel Name Not Available' }}</span></span>

                                                </p>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <div class="mb-2" style="font-weight:500;"><span
                                                            style="font-weight:500; color: #0D1425;"> <i
                                                                class="fa-solid fa-bus"></i> Departure Days :
                                                        </span><span>Every Wednesday</span> </div>
                                                    @php
                                                        $departCities = explode(',', $package->depart_city);
                                                    @endphp
                                                    <div class="mb-2" style="font-weight:500;">
                                                        <span style="font-weight:500; color: #0D1425;"> <i
                                                    ...
                                                    <div>
                                                        <div class="d-flex mb-2">
                                                            <img style="height: 20px;"
                                                                src="{{ asset('images/googlereview.png') }}"
                                                                alt="googlereview">
                                                            <div class="ms-2">
                                                                <span>4.5</span>
                                                                ...
                                                                <a style="color: #007bff; text-decoration: underline;"
                                                                    target="_blank"
                                                                    href="https://www.google.com/search?q=rahat+travels&oq=rahat+travels&gs_lcrp=EgZjaHJvbWUyCQgAEEUYORiABDIGCAEQIxgnMgwIAhAAGBQYhwIYgAQyDAgDEAAYFBiHAhiABDINCAQQLhivARjHARiABDIHCAUQABiABDIGCAYQRRg8MgYIBxBFGD3SAQg0OTUxajBqNKgCALACAQ&sourceid=chrome&ie=UTF-8#lrd=0x3be7ce3cd58b13c3:0xb07729f581586b81,1,,,,">Google
                                                                    review</a>
                                                ...
                                                <div class="d-flex flex-column gap-3">
                                                    <a class="btn btn-sm btn-primary rounded py-2 px-4 me-2"
                                                        href="{{ route('viewPackageDetails', $package->id) }}">
                                                        <i class="fa-solid fa-file-zipper"></i> View Packages
                                                    </a>
                                                    <a class="btn btn-sm btn-dark rounded py-2 px-4"
                                                        wire:click="openModal({{ $package }})">
