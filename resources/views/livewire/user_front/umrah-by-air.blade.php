                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <h3 class="display-3 text-white mb-4 animated slideInDown">Umrah Package By Air From Dubai</h3>
    ...
    <div class="container">
        <div class="bg-white shadow" style="padding: 15px; border: 2px dotted red;">
            ...
            <div class="row mt-4 d-flex justify-content-center">
                ...
                <div class="col-md-3 text-center">
                    <div class="package-info">
                        <h5 style="color:#FEAF39">Flight Depart</h5>
                        <p>Every Monday</p>
                    </div>
                </div>
                <div class="col-md-3 text-center">
        ...
        <div class="container-xxl py-5" id="about">
            <div class="container" >
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h4 class=" text-start text-primary text-uppercase">Vip Umrah Packages From Dubai & Sharjah</h4>
                        <!-- <h1 class="mb-4">RAMADAN UMRAH PACKAGE <span class="text-primary text-uppercase">FROM SHARJAH & DUBAI </span></h1> -->
                        <p class="mb-4">Our Umrah Package by Air include 3 start 4 star & 5 star hotel with sharing accommodation return tickets and Umrah visa . Umrah by air packages without sharing accommodation also available for families.</p>
                        <p class="mb-4">With several years of expertise in Umrah tours management and successful 2016-17 umrah operations we have created huge and satisfied clientele making our specially designed umrah pacakages.</p>
                        <p class="mb-4">We have planned to keep on providing best and affordable umrah packages in 2018 by having connected with multiple airlines to serve our customers with quality and comfort at best affordable rates for best Umrah Package by Bus & Air in Dubai/UAE.</p>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase mb-5">Umrah Package By Air From Dubai</h6>
