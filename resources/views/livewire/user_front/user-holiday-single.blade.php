        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-9">
                    ...
                    <h3 class="mb-3 section-title text-start text-primary text-uppercase">{{$HolidayDetails->name}}</h3>
                    ...
                    <div class="container-fluid p-0 mb-5">
                        <div class="" id="">
                            <div class="">
                                    ...
                                    <div class="">
                                    <img  src="{{ Storage::url($this->HolidayDetails->packageImage) }}" style="height: 35rem; width: 100%;" alt="Ziyarat  Image">
                                    </div>
                    ...
                    <h5 style="font-size: xx-large; font-family: 'Poppins', sans-serif;">DESCRIPTION</h5>
                        <ul>
                            @foreach (explode('.', $HolidayDetails->description) as $sentence)
                            @if(trim($sentence))
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="packageoverviewbox">
                                ...
                                <div class="rates-row">
                                    ...
                                    @if ($HolidayDetails->g_share_price > 0 )
                                    <div class="rate">
                                    <h3>Sharing</h3>
                                    <span class="rate-value">{{ $HolidayDetails->g_share_price}}</span>
                                    ...
                                    @if ($HolidayDetails->qt_share_price > 0)
                                    <div class="rate">
                                    <h3>Quint</h3>
                                    <span class="rate-value">{{$HolidayDetails->qt_share_price}}</span>
                                    <span class="rate-icon">
                                    ...
                                    @if ($HolidayDetails->qd_share_price > 0)
                                    <div class="rate">
                                    <h3>Quad</h3>
                                    <span class="rate-value">{{$HolidayDetails->qd_share_price}}</span>
                                    <span class="rate-icon">
                                    ...
                                    @if ($HolidayDetails->t_share_price > 0)
                                    <div class="rate">
                                    <h3>Triple</h3>
                                    <span class="rate-value">{{$HolidayDetails->t_share_price}}</span>
                                    <span class="rate-icon">
                                    ...
                                    @if ($HolidayDetails->d_share_price > 0)
                                    <div class="rate">
                                    <h3>Double</h3>
                                    <span class="rate-value">{{$HolidayDetails->d_share_price}}</span>
                                    <span class="rate-icon">
                                    ...
                                    @if ($HolidayDetails->single_price > 0)
                                    <div class="rate">
                                    <h3>Single</h3>
                                    <span class="rate-value">{{$HolidayDetails->single_price}}</span>
                                    <span class="rate-icon">
                                ...
                                <!-- <h3>Child Rates</h3> -->
                                <div class="rates-row">
                                    @if ($HolidayDetails->child_w_b > 0)
                                    <div class="rate">
                                    <h4>Child with Bed</h4>
                                    <span class="rate-value">{{$HolidayDetails->child_w_b}}</span>
                                    ...
                                    @if ($HolidayDetails->child_wo_b > 0)
                                    <div class="rate">
                                    <h4>Child without Bed</h4>
                                    <span class="rate-value">{{$HolidayDetails->child_wo_b}}</span>
                                    <span class="rate-icon"><i style="color:#0078C4" class="fa-solid fa-child"></i> </span><!-- Example icon -->
                                    </div>
                                    @endif

                                    @if ($HolidayDetails->infants > 0)
                                    <div class="rate">
                                    <h4>Infant</h4>
                                    <span class="rate-value">{{$HolidayDetails->infants}}</span>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="packageoverviewbox">
                                ...
                                <!-- <h3 class="mb-3 section-title text-start text-primary text-uppercase">Package Overview</h3> -->
                                    <ul>
                                        @foreach (explode('.', $HolidayDetails->payment_policy) as $sentence)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 mb-3">
                            <div class="box box-1">
                                ...
                                @foreach (explode('.', $HolidayDetails->inclusion) as $sentence)
                                    @if(trim($sentence))
                                        <li style="padding-left: 0; margin: 0;">
                                            <div class="d-flex">
                                                <img src="{{asset('asserts/user/img/svg/tick.svg')}}" height="25px" alt="">
                        ...
                        <div class="col-md-12 col-sm-12 mb-3">
                            <div class="box box-2">
                                ...
                                <ul>
                                    @foreach (explode('.', $HolidayDetails->exclusion) as $sentence)
                                        @if(trim($sentence))
                                            <li style="padding-left: 0; margin: 0;">
                                                <div class="d-flex">
                                                    <img src="{{asset('asserts/user/img/svg/tick.svg')}}" height="25px" alt="">
            ...
            <div id="Itinerary" class="tab-pane fade show" role="tabpanel">
                <div class="container">
                    <div class="row" style="margin-top:40px">
                        ...
                        <div class="container">
                            <div class="timeline">
                                @foreach (explode('.', $HolidayDetails->itinerary) as $sentence)
                                    @if(trim($sentence))
                    ...
                    <div class="row" style="margin-top:40px">
                        ...
                        <div class="col-md-12 col-sm-12 mb-3">
                            <div class="box box-3">
                                ...
                                <ul>
                                    @foreach (explode('.', $HolidayDetails->cancellation_policy) as $sentence)
                                        @if(trim($sentence))
                                            <li style="padding-left: 0; margin: 0;">
                                                <div class="d-flex">
                                                    <img src="{{asset('asserts/user/img/svg/tick.svg')}}" height="25px" alt="">
