                    ...
                    <div class="row g-2">
                        <div class="col-md-8">
                            <form wire:submit.prevent="" class="date" id="date2" >
                                <input  wire:model.live="search" type="text" class="form-control" placeholder="Search Holiday Name" />
                            </form>
                        </div>
                        <div class="col-md-4">
   ...
   <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <!---package-start------>
                @foreach ( $HolidayDetails as $package  )
                            ...
                            <div>
                              ...
                              <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <a href="{{route('user.holiday-single',['id' => $package->id])}}" class="btn btn-sm btn-primary rounded py-2 px-4 me-2" >
