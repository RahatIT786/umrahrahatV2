<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex align-items-center mb-3">
            <h4 class="mb-0">All Package Request Command</h4>
                ...
                <tbody>
                    @foreach ($CommandDatas as $index => $CommandData)
                        <tr>
                            ...
                            <td>
                                @if($CommandData->previous_status == 'pending') Pending
                                @elseif($CommandData->previous_status == 'responded') Responded
                                @elseif($CommandData->previous_status == 'no responded') No Responded
                                @endif
                            </td> 
