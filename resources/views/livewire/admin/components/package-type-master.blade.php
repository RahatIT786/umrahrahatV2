<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h6 class="card-title mb-0">Package Type Management</h6>
            <a href="{{ route('addPackageType') }}" wire:navigate class="btn btn-sm btn-primary">
                <i class="bx bx-plus me-1"></i> Create Package Type
            </a>
        </div>

        <!-- Search Bar -->
        <div class="d-flex align-items-center mb-3">
            <h4 class="mb-0">All Package Types</h4>
            ...
            <table class="table align-middle">
                <thead class="table-secondary">
                    <tr>
                        ...
                        <th class="border-0 py-2">Package Type Name</th>
                    ...
                    @foreach ($PackageTypes as $index => $packageType)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="text-primary" href="{{ route('packageTypeEdit', ['id' => $packageType->id]) }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                            </td>
                            <td class="text-center">
                                <a wire:click="confirmDelete({{ $packageType->id }})" class="text-danger" data-bs-placement="bottom" title="Delete" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal">
