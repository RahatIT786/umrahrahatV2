                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="footPrice" wire:model="foodPrice" class="form-control" placeholder="Enter Price">
                    ...
                    <!-- Flight & Transport -->
                     ...
                     <!-- File Upload for Supporting Image -->
                      ...
                      {{-- <div class="col-md-4 mb-3">
                            ...
                            @if ($foodLunchImage)
                            <div class="mt-3">
                                <img src="{{ $foodLunchImage->temporaryUrl() }}" alt="Preview" class="img-thumbnail" style="max-width: 200px;">
                            </div>
