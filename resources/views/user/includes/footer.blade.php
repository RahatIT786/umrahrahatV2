        ...
        <div class="container-fluid bg-dark text-light footer wow fadeIn" data-wow-delay="0.1s" style="visibility: visible;animation-delay: 0.1s;animation-name: fadeIn;padding-top: 50px;">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="row gy-5 g-4">
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link" href="{{route('agm')}}">Awards & Recognition</a>
            ...
            <!-- <div class="container pb-5">
                <div class="row g-5 d-flex justify-content-center" id="footer-contact">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">SHARJAH - DUBAI</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>705, F1 Building, Rolla Market,<br> Near Hisn Fort. <br>Sharjah.</p>
    ...
    <script src="{{asset('asserts/user/lib/counterup/counterup.min.js')}}"></script>
