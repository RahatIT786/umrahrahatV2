...
class UmrahByFlightFromUAE extends Component
{
    public $allPackages;
    public $inclusions;
    public $departCities;
    ...
    public function render()
    {
        ...
        return view('livewire.user_front.umrah.umrah-by-flight-from-u-a-e', ['allPackages' => $this->allPackages, 'departCities' => $this->departCities]);
    }
}
