...
public $hotelIdsString;
    ...
    public function mount(){
        ...
        $this->HolidayCity = HolidayCity::where('delete_status',1)->get();
        ...
        public function save(){
            ...
            //dump($departCity);
                ...
                $pkg_data = [
                 ...
                 $package = MainHoliday::create($pkg_data);


                    session()->flash('message', 'Holiday details added successfully!');
    ...
    {
        return view('livewire.admin.components.add-holidays');
    }
}
